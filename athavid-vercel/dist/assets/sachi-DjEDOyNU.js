							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
										...
										children: "🎙️ Native Sachi Live (OBS / Streamlabs)"
										...
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
											...
											children: "Paste these into OBS → Settings → Stream:"
										}),
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											style: {
												background: "rgba(0,0,0,0.3)",
										...
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
											...
											children: "Your stream saves automatically as an episode after going live 🎬"
										})
									] }) : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
										style: {
											color: "rgba(255,255,255,0.4)",
										...
										children: "Get your personal RTMP stream key to broadcast live directly on Sachi using OBS or Streamlabs."
									}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
										onClick: async () => {
											if (loadingStreamKey) return;
											setLoadingStreamKey(true);
											try {
												const cfData = await (await fetch(`https://api.cloudflare.com/client/v4/accounts/a346b1c78fc48549d2de3de99a789a2d/stream/live_inputs`, {
													method: "POST",
													headers: {
														"Authorization": "Bearer cfut_WBRlGeCzjayXrqMz3zas4SivKZLOVavDMvV6hmQ91093a97c",
														"Content-Type": "application/json"
													},
													body: JSON.stringify({
														meta: { name: `${selectedPodcast.title} - ${selectedPodcast.host_username || currentUser?.username || "host"}` },
														recording: {
															mode: "automatic",
															timeoutSeconds: 10
														},
