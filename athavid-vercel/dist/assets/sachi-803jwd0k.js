...
function Landing({ onEnter }) {
	...
	const [petals] = (0, import_react.useState)(() => Array.from({ length: 16 }, (_, i) => ({
		id: i,
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
      ...
      ` }),
			Array.from({ length: 38 }, (_, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: {
				position: "absolute",
			...
			petals.map((p) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				style: {
					position: "absolute",
					top: -20,
					left: p.left,
...
//#endregion
//#region src/api.js
var APP_ID$2 = "69b2ee18a8e6fb58c7f0261c";
...
var auth = {
	async signIn(email, password) {
		const data = await request$1("POST", `/apps/${APP_ID$2}/auth/login`, {
			email,
			password
		});
	...
	async signUp(email, password, fullName) {
		return request$1("POST", `/apps/${APP_ID$2}/auth/register`, {
			email,
			password,
			full_name: fullName
		});
	...
	async verifyOtp(email, otpCode) {
		const data = await request$1("POST", `/apps/${APP_ID$2}/auth/verify-otp`, {
			email,
			otp_code: otpCode
		});
		const token = data.access_token || data.token;
...
var videos = {
	...
	async update(id, data) {
		return request$1("PUT", `/apps/${APP_ID$2}/entities/SachiVideo/${id}`, data);
	},
	...
	async delete(id) {
		return request$1("DELETE", `/apps/${APP_ID$2}/entities/SachiVideo/${id}`);
	}
};
var comments = {
	async list(videoId) {
	...
	async update(id, data) {
		return request$1("PUT", `/apps/${APP_ID$2}/entities/SachiComment/${id}`, data);
	},
	async delete(id) {
		return request$1("DELETE", `/apps/${APP_ID$2}/entities/SachiComment/${id}`);
	}
};
...
var reports = {
	...
	async update(id, data) {
		return request$1("PUT", `/apps/${APP_ID$2}/entities/SachiReport/${id}`, data);
	}
};
var bookmarks = {
	async add(user_id, username, video_id) {
		return request$1("POST", `/apps/${APP_ID$2}/entities/SachiBookmark`, {
			user_id,
			username,
			video_id
		});
	...
	async remove(id) {
		return request$1("DELETE", `/apps/${APP_ID$2}/entities/SachiBookmark/${id}`);
	},
...
var blocks = {
	async block(blocker_id, blocker_username, blocked_id, blocked_username) {
		return request$1("POST", `/apps/${APP_ID$2}/entities/SachiBlock`, {
			blocker_id,
			blocker_username,
			blocked_id,
			blocked_username
	...
	async unblock(id) {
		return request$1("DELETE", `/apps/${APP_ID$2}/entities/SachiBlock/${id}`);
	},
...
var interests = {
	...
	async signal(userId, hashtags, points) {
		...
		for (const tag of hashtags) {
			...
			} else await request$1("POST", `/apps/${APP_ID$2}/entities/UserInterest`, {
				user_id: userId,
				hashtag: clean,
				score: points,
				last_updated: now
...
var likes = {
	...
	async remove(id) {
		return request$1("DELETE", `/apps/${APP_ID$2}/entities/SachiLike/${id}`);
	},
...
var GOOGLE_CLIENT_ID$1 = "124061688969-7ebbn8gph1ej84dli790clptp32gosdt.apps.googleusercontent.com";
...
async function lookupSachiUser(email) {
	try {
		const data = await (await fetch(`${BASE_URL}/apps/${APP_ID$1}/entities/AthaVidUser?email=${encodeURIComponent(email)}&limit=5`, { headers: { "Content-Type": "application/json" } })).json();
...
async function signInWithGooglePopup(onSuccess) {
	...
	google.accounts.id.prompt((notification) => {
		if (notification.isNotDisplayed() || notification.isSkippedMoment()) {
			...
			if (div) google.accounts.id.renderButton(div, {
				theme: "outline",
				size: "large"
			});
		}
...
function FinishStep({ googlePayload, onSuccess }) {
	...
	const handleFinish = async () => {
		...
		setError("");
		try {
			const created = await fetch(`${BASE_URL}/apps/${APP_ID$1}/entities/AthaVidUser`, {
				method: "POST",
...
//#endregion
//#region src/FoundingCreator.jsx
var CONTENT_TYPES = [
	"Short Videos",
	"Podcasts",
	"Live Streams",
...
var PERKS = [
	{
		...
		desc: "Permanent verified badge on your profile — shows you were here from day one."
	},
	{
		icon: "🎙️",
		title: "First Live Podcast Slot",
		desc: "Priority access to go live on Sachi Stream before the public launch."
	},
	{
		icon: "📣",
		title: "Featured in the Feed",
		desc: "Your content gets promoted to every new user during the first 30 days."
	},
	{
		icon: "🚫",
		title: "Zero Censorship — Ever",
		desc: "No shadowbanning. No algorithm suppression. No demonetisation risk."
	},
	{
		icon: "📊",
		title: "Early Analytics Access",
		desc: "Full creator dashboard before it's available to the public."
	},
	{
		icon: "💬",
		title: "Direct Line to the Team",
		desc: "Your feedback goes straight to the founders. You help shape this platform."
	}
];
function FoundingCreatorPage({ onBack }) {
	...
	const submit = async () => {
		...
		setLoading(true);
		try {
			await request$1("POST", "/apps/69b2ee18a8e6fb58c7f0261c/entities/FoundingCreator", {
				...form,
				status: "Pending"
			});
			setStep(3);
	...
	if (step === 3) return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		style: {
			minHeight: "100dvh",
			background: "linear-gradient(160deg,#0B0C1A 0%,#12132B 60%,#1a0f2e 100%)",
			display: "flex",
			flexDirection: "column",
			alignItems: "center",
			justifyContent: "center",
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				...
				children: "Your application has been received. We'll review it and get back to you within 48 hours."
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
				style: {
					color: "#888",
	...
	if (step === 2) return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		style: {
			minHeight: "100dvh",
			background: "linear-gradient(160deg,#0B0C1A 0%,#12132B 100%)",
			paddingBottom: 40
		},
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
				...
				children: "Founding Creator Application"
			}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				style: {
					color: "#888",
					fontSize: 12
				},
				children: "Takes about 3 minutes · 50 spots available"
			})] })]
		}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			style: {
				padding: "24px 20px",
			...
			children: [
				...
				].map(({ label, key, type, placeholder }) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", {
						...
						children: "What type of content do you make? *"
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						style: {
							display: "flex",
							flexWrap: "wrap",
						...
						children: CONTENT_TYPES.map((t) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
							...
							style: {
								...
								padding: "7px 14px",
								fontSize: 13,
								fontWeight: form.content_type === t ? 700 : 400,
								cursor: "pointer"
							},
							children: t
						}, t))
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", {
						...
						children: "Current audience size (all platforms)"
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						style: {
							display: "flex",
							flexWrap: "wrap",
						...
						children: FOLLOWER_OPTIONS.map((f) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
							onClick: () => set("follower_count", f),
							style: {
								...
								padding: "7px 14px",
								fontSize: 13,
								fontWeight: form.follower_count === f ? 700 : 400,
								cursor: "pointer"
							},
							children: f
						}, f))
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", {
						...
						children: "Tell us about your content"
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", {
						...
						children: "Why do you want to join Sachi? *"
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("textarea", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						...
						children: "Limited — 50 Founding Spots"
					}),
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						...
						children: "No charge. No obligation. Just your story."
					})
				]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: {
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
					...
					children: "What Founding Creators Get"
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					style: {
						display: "flex",
						flexDirection: "column",
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						...
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("em", { children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						...
						children: "— Jaya Gunaratne, Founder of Sachi Stream"
					})
				]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
					...
					children: "Launching May 2026 · 50 spots · sachistream.com"
				})]
			})
		]
	});
...
//#endregion
//#region src/MusicPicker.jsx
var APP_NAME = "SachiStream";
var AUDIUS_BASE = "https://api.audius.co/v1";
var GENRES = [
	"All",
	"Hip-Hop",
	"Pop",
...
async function searchTracks(query) {
	return (await (await fetch(`${AUDIUS_BASE}/tracks/search?app_name=${APP_NAME}&query=${encodeURIComponent(query)}&limit=20`)).json()).data || [];
}
...
function MusicPicker({ onSelect, onClose, currentSound }) {
	...
	const [originalSounds, setOriginalSounds] = (0, import_react.useState)([]);
	...
	(0, import_react.useEffect)(() => {
		...
		fetch(`https://sachi-c7f0261c.base44.app/api/apps/69b2ee18a8e6fb58c7f0261c/entities/SachiVideo?has_sound=true&limit=50&sort=-created_date`, { headers: { "Content-Type": "application/json" } }).then((r) => r.json()).then((d) => {
			setOriginalSounds((Array.isArray(d) ? d : d.records || d.data || []).filter((v) => v.sound_url || v.video_url));
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
							style: TAB_STYLE(tab === "original"),
							onClick: () => setTab("original"),
							children: "🎤 Sachi Sounds"
						})
					]
				}),
				tab === "trending" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					style: {
						display: "flex",
						gap: 8,
						overflowX: "auto",
				...
				tab === "search" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				currentSound && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					style: {
						margin: "0 16px 8px",
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							...
							children: currentSound.sound_title
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							style: {
								color: "#aaa",
							...
							children: currentSound.sound_artist
						})
					] }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
						onClick: clearSound,
						style: {
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [(tab === "trending" || tab === "search") && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
						(loading || searching) && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							style: {
								textAlign: "center",
								padding: "40px 20px",
								color: "#666"
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								...
								children: "🎵"
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { children: searching ? "Searching..." : "Loading music..." })]
						}),
						!loading && !searching && tracks.length === 0 && tab === "search" && searchQuery && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							style: {
								textAlign: "center",
								padding: "40px 20px",
								color: "#666"
						...
						!loading && !searching && tracks.length === 0 && tab === "search" && !searchQuery && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								...
								children: "🎵"
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { children: "Type to search for music" })]
						}),
						!loading && !searching && tracks.map((track) => {
							...
							return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								style: {
									...
									background: isPlaying ? "rgba(245,200,66,0.06)" : "transparent"
								},
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										style: {
										...
										children: [artwork ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
											src: artwork,
											alt: "",
											style: {
												width: "100%",
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										...
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
											...
											style: {
												background: isPlaying ? "rgba(245,200,66,0.2)" : "rgba(255,255,255,0.08)",
												border: "none",
												borderRadius: 8,
												width: 34,
												height: 34,
												cursor: "pointer",
												color: isPlaying ? "#F5C842" : "#ccc",
												fontSize: 14,
												display: "flex",
												alignItems: "center",
												justifyContent: "center"
											...
											onClick: () => selectAudiusTrack(track),
											style: {
						...
						!loading && tracks.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							style: {
								textAlign: "center",
								padding: "12px",
								color: "#444",
					...
					] }), tab === "original" && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						...
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							...
							children: "🎤 Sounds created by Sachi creators. Use them on your own videos."
						})
					}), originalSounds.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						style: {
							textAlign: "center",
							padding: "40px 20px",
							color: "#666"
						...
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								...
								children: "No original sounds yet"
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								style: { fontSize: 13 },
								children: "Post a video — your audio becomes a sound other creators can use."
							})
						]
					}) : originalSounds.map((v) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						style: {
							display: "flex",
							alignItems: "center",
							gap: 12,
						...
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
									...
									children: v.sound_title || v.caption || "Original Sound"
								}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
									style: {
										color: "#888",
										fontSize: 12
									},
									children: v.display_name || v.username
								})]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
								onClick: () => selectOriginalSound(v),
								style: {
									background: "rgba(245,200,66,0.15)",
									border: "1px solid rgba(245,200,66,0.3)",
									borderRadius: 8,
...
function countryFlag(code) {
	...
	try {
		const iso = nameToCode[code.toLowerCase().trim()] || (code.length === 2 ? code.toUpperCase() : null);
...
function CommentSheet({ video, currentUser, onClose, onCommentPosted, onNeedAuth }) {
	...
	const [emojiPickerOpen, setEmojiPickerOpen] = (0, import_react.useState)(null);
	...
	const reactToComment = async (id, reaction, isReply, parentId, emoji = null) => {
		if (reaction === "emoji_reactions" && emoji) {
			...
			if (isReply) setList((prev) => prev.map((x) => x.id === parentId ? {
				...x,
				replies: (x.replies || []).map((r) => r.id === id ? updateItem(r) : r)
			} : x));
			else setList((prev) => prev.map((x) => x.id === id ? updateItem(x) : x));
			try {
				...
				console.error("Emoji reaction save failed:", e);
			}
			return;
		}
		if (isReply) setList((prev) => prev.map((x) => x.id === parentId ? {
		...
		try {
			const current = list.find((x) => isReply ? x.id === parentId : x.id === id);
			const commentToUpdate = isReply ? (current?.replies || []).find((r) => r.id === id) : current;
			if (commentToUpdate) await comments.update(id, { [reaction]: (commentToUpdate[reaction] || 0) + 1 });
		} catch (e) {
...
function UploadModal({ currentUser, onClose, onUploaded }) {
	...
	const detectLocation = async () => {
		...
		try {
			...
			setPostLocation({
				name: [city, getStateAbbr(state, country_code) || state].filter(Boolean).join(", "),
				city,
				state,
				country_code
			});
			...
			children: [
							...
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										...
										children: [
											...
											postLocation && !detectingLocation && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
												style: {
													color: "#8BC34A",
													fontSize: 13,
													fontWeight: 600
												},
												children: ["✓ ", postLocation.name]
											}),
											!postLocation && !detectingLocation && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
												...
												children: "Not set — tap to detect"
											})
										]
									})]
								}),
								postLocation && !detectingLocation && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
									style: {
										display: "flex",
										gap: 8,
										paddingBottom: 12,
								...
								!postLocation && !detectingLocation && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
									...
									children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
										...
										children: "📍 Location is required to post on Sachi. Tap above to detect automatically."
									})
								})
							]
						}),
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
						...
						children: uploading ? step : detectingLocation ? "📡 Detecting location..." : !postLocation ? "📍 Location required" : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							style: { fontSize: 18 },
							children: "⬆"
						}), " Post"] })
					})]
						...
						uploadTab !== "text" && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								style: {
									...
									gap: 10,
									background: "rgba(255,255,255,0.06)",
									border: `1px solid ${selectedTrack ? "rgba(245,200,66,0.4)" : "rgba(255,255,255,0.1)"}`,
									borderRadius: 12,
									padding: "12px 14px",
									marginBottom: 12,
									cursor: "pointer"
								...
								children: [
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										...
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
											style: {
												color: selectedTrack ? "#F5C842" : "#fff",
												fontWeight: 700,
												fontSize: 14
											},
											children: selectedTrack ? selectedTrack.sound_title || selectedTrack.title : "Add Sound"
										}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
											style: {
												color: "#888",
												fontSize: 12
											},
											children: selectedTrack ? selectedTrack.sound_artist || selectedTrack.artist : "Pick from trending, search, or Sachi creators"
										})]
									}),
							...
							showMusicPicker && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(MusicPicker, {
...
function VideoCard({ video, currentUser, onCommentOpen, onLike, onView, onNeedAuth, onDelete, onProfileOpen, followedUserIds, onFollowChange, onShareCount, onBookmark, blockedIds }) {
	...
	const [likeLoading, setLikeLoading] = (0, import_react.useState)(false);
	const [likeRecordId, setLikeRecordId] = (0, import_react.useState)(null);
	const [showLikesPanel, setShowLikesPanel] = (0, import_react.useState)(false);
	const [likesList, setLikesList] = (0, import_react.useState)([]);
	const [likesListLoading, setLikesListLoading] = (0, import_react.useState)(false);
	...
	const doLike = async () => {
		...
		try {
			if (liked) {
				...
				const rec = await likes.add(video.id, currentUser.id, currentUser.username || currentUser.email?.split("@")[0] || "user", currentUser.display_name || currentUser.full_name || currentUser.username || "User", currentUser.avatar_url || currentUser.picture || "");
				setLiked(true);
				setLikeRecordId(rec.id);
				onLike(video.id, 1);
			}
	...
	const openLikesPanel = async () => {
		...
		try {
			...
			setLikesList(Array.isArray(res) ? res : res?.records || res?.items || []);
		} catch (e) {
			setLikesList([]);
		}
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
					...
					video.created_date && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							...
							children: [formatDate(video.created_date), video.post_country && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
								...
								children: [countryFlag(video.post_country), (() => {
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
							...
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								...
								children: likeLoading ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
									style: { fontSize: 10 },
									children: "⏳"
			...
			showLikesPanel && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				style: {
					position: "fixed",
					inset: 0,
					zIndex: 9999,
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								...
								children: likesListLoading ? "Likes" : `${likesList.length} ${likesList.length === 1 ? "Like" : "Likes"}`
							})]
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
							onClick: () => setShowLikesPanel(false),
							style: {
						...
						children: likesListLoading ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							style: {
								textAlign: "center",
								color: "#555",
								padding: 40,
							...
							children: "Loading…"
						}) : likesList.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							style: {
								textAlign: "center",
								padding: 40
							},
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								...
								children: "No likes yet — be the first!"
							})]
						}) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							style: {
								display: "flex",
							...
							children: likesList.map((lk, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								style: {
									display: "flex",
									alignItems: "center",
									gap: 12,
								...
								children: [
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										...
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
											...
											children: lk.display_name || lk.username || "User"
										}), lk.username && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											style: {
												color: "rgba(255,255,255,0.4)",
												fontSize: 12
											},
											children: ["@", lk.username]
										})]
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
										style: {
...
function AvatarPickerModal({ currentAvatar, onSelect, onClose }) {
	...
	const handleCropSave = async (dataUrl) => {
		...
		setUploading(true);
		try {
			const data = await (await fetch("https://sachi-c7f0261c.base44.app/functions/uploadAvatar", {
				method: "POST",
				headers: { "Content-Type": "application/json" },
				body: JSON.stringify({
...
function PodcastPage({ currentUser, onNeedAuth }) {
	...
	const [loadingStreamKey, setLoadingStreamKey] = (0, import_react.useState)(false);
	const [showStreamKey, setShowStreamKey] = (0, import_react.useState)(false);
	const [streamCreds, setStreamCreds] = (0, import_react.useState)(null);
	...
	const loadPodcasts = async () => {
		...
		try {
			const data = await request$1("GET", `/apps/69b2ee18a8e6fb58c7f0261c/entities/SachiPodcast?status=Active`);
	...
	const loadMyShows = async () => {
		if (!currentUser) return;
		try {
			const data = await request$1("GET", `/apps/69b2ee18a8e6fb58c7f0261c/entities/SachiPodcast`);
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
										...
										children: "🎙️ Native Sachi Live Stream (via Cloudflare)"
									}), selectedPodcast.stream_key ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
											style: {
												color: "rgba(255,255,255,0.5)",
												fontSize: 11,
											...
											children: "Use these in OBS / Streamlabs:"
										}),
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											style: {
												background: "rgba(0,0,0,0.3)",
											...
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
												...
												children: "rtmps://live.cloudflare.com:443/live/"
											})]
										}),
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											style: {
											...
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
												...
												children: [
													/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
														...
														children: showStreamKey ? selectedPodcast.stream_key : "••••••••••••••••••••••••"
													}),
													/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
													...
													/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
														...
														style: {
															background: "rgba(108,60,247,0.3)",
															border: "none",
															borderRadius: 6,
															padding: "4px 8px",
															color: "#a78bfa",
										...
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
											...
											children: "Stream saves automatically as an episode after you go live 🎬"
										})
									] }) : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
										style: {
											color: "rgba(255,255,255,0.4)",
										...
										children: "Get your personal RTMP stream key to go live directly on Sachi using OBS or Streamlabs."
									}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
										onClick: async () => {
											if (loadingStreamKey) return;
											setLoadingStreamKey(true);
											try {
												const data = await (await fetch("https://sachi-c7f0261c.base44.app/functions/createLiveStream", {
													method: "POST",
													headers: { "Content-Type": "application/json" },
													body: JSON.stringify({
														podcast_id: selectedPodcast.id,
														podcast_title: selectedPodcast.title,
														host_username: selectedPodcast.host_username || currentUser?.username
													})
												})).json();
												if (data.success) {
													setSelectedPodcast((p) => ({
												...
												} else showToast("Failed to create stream. Try again.", "error");
											} catch (e) {
										...
										style: {
											width: "100%",
											padding: "11px 0",
											background: loadingStreamKey ? "rgba(245,200,66,0.2)" : "rgba(245,200,66,0.15)",
										...
										children: loadingStreamKey ? "⏳ Generating..." : "⚡ Generate My Stream Key"
									})] })]
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									style: {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
										...
										children: "🎙️ Native Sachi Live (via Cloudflare)"
									}), selectedPodcast.stream_key ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
											style: {
												color: "rgba(255,255,255,0.5)",
											...
											children: "Use in OBS / Streamlabs:"
										}),
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											style: {
												background: "rgba(0,0,0,0.3)",
										...
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
											...
											children: "Stream saves automatically as an episode after going live 🎬"
										})
									] }) : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
										style: {
											color: "rgba(255,255,255,0.4)",
										...
										children: "Get your personal RTMP stream key to go live on Sachi using OBS or Streamlabs."
									}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
										onClick: async () => {
											if (loadingStreamKey) return;
											setLoadingStreamKey(true);
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
	...
	}), liveNewsChannel && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		style: {
			position: "fixed",
			inset: 0,
			zIndex: 9999,
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: LIVE_NEWS_CHANNELS.map((ch) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
					onClick: () => setLiveNewsChannel(ch),
					style: {
						flexShrink: 0,
						display: "flex",
...
function AdminPanel({ currentUser }) {
	...
	const [analyticsError, setAnalyticsError] = (0, import_react.useState)(null);
	...
	const loadAnalytics = async () => {
		...
		try {
			const data = await (await fetch("https://sachi-c7f0261c.base44.app/functions/getAdminStats", {
				method: "POST",
				headers: { "Content-Type": "application/json" },
				body: "{}"
			})).json();
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			modTab === "analytics" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				}) : analyticsError ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					style: {
						textAlign: "center",
						color: "#FF6B6B",
						padding: 40,
							...
							children: [
								...
								children: [
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
										...
										children: typeof val === "number" ? val.toLocaleString() : val
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
										style: {
											color: "#555",
						...
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								...
								children: (() => {
									...
									const weekLabel = `${weekAgoD.toLocaleDateString("en-US", {
										month: "short",
										day: "numeric"
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								...
								children: (analyticsData.recentUsers || []).map((u, i) => {
									const joinDate = u.created_date ? new Date(u.created_date) : null;
									const today = /* @__PURE__ */ new Date();
									const isNew = joinDate && today - joinDate < 1440 * 60 * 1e3;
									const isThisWeek = joinDate && today - joinDate < 10080 * 60 * 1e3;
									return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										style: {
											display: "flex",
											alignItems: "center",
											...
											borderRadius: 10,
											padding: "10px 12px",
											border: isNew ? "1px solid rgba(107,255,184,0.25)" : "1px solid transparent"
										},
										children: [
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
												style: {
											...
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
												src: u.avatar_url || u.picture || `https://ui-avatars.com/api/?name=${encodeURIComponent(u.display_name || u.username || u.email || "?")}&background=random&color=fff&size=64&bold=true&format=png`,
												style: {
													width: 32,
													height: 32,
													borderRadius: "50%",
											...
											/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
												...
												children: [
													/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
														...
														children: [u.display_name || u.full_name || u.username || "—", isNew && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
															style: {
																marginLeft: 6,
																background: "#6BFFB8",
																color: "#0B0C1A",
													...
													/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
														...
														children: [u.email || "", u.username ? ` · @${u.username}` : ""]
													}),
													u.location && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
														style: {
															color: "#444",
															fontSize: 10,
															marginTop: 1
											...
											/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
												...
												children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
													style: {
														color: isNew ? "#6BFFB8" : isThisWeek ? "#F5C842" : "#444",
														fontSize: 10,
														fontWeight: 600
													},
													children: joinDate ? joinDate.toLocaleDateString("en-US", {
														month: "short",
														day: "numeric",
														year: "numeric"
													}) : "—"
													...
													children: joinDate ? joinDate.toLocaleTimeString("en-US", {
														hour: "2-digit",
														minute: "2-digit"
													}) : ""
												})]
				...
				children: usersLoading ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					...
					return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
						...
						(() => {
							...
							return sorted.length > 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								style: {
									background: "rgba(245,200,66,0.06)",
									borderRadius: 16,
									border: "1px solid rgba(245,200,66,0.15)",
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
									...
									children: sorted.map(([loc, count]) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										style: {
											background: "rgba(245,200,66,0.12)",
											borderRadius: 20,
											padding: "4px 12px",
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [registeredUsers.map((u, i) => {
											...
											/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
												...
												children: [
													...
													/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
														...
														children: locationFlag(u.location)
													})
												]
											}),
											/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
												...
												children: [
													...
													/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
														...
														children: u.created_date ? new Date(u.created_date).toLocaleTimeString("en-US", {
															hour: "2-digit",
															minute: "2-digit"
														}) : ""
													}),
								...
								}), registeredUsers.length === 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
									style: {
										textAlign: "center",
										color: "#444",
										padding: 40,
...
function App() {
	...
	if (path === "/founding-creator" || path === "/apply") return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FoundingCreatorPage, { onBack: () => window.location.href = "/" });
	...
	const [showFollowersList, setShowFollowersList] = (0, import_react.useState)(false);
	const [showFollowingList, setShowFollowingList] = (0, import_react.useState)(false);
	const [followersList, setFollowersList] = (0, import_react.useState)([]);
	const [followingList, setFollowingList] = (0, import_react.useState)([]);
	const [followListLoading, setFollowListLoading] = (0, import_react.useState)(false);
	...
	(0, import_react.useEffect)(() => {
		const loadAvatar = async () => {
			if (currentUser) try {
				...
				} else if (currentUser.avatar_url && !currentUser.avatar_url.startsWith("data:")) setAvatarUrl(currentUser.avatar_url);
				else {
	...
	(0, import_react.useEffect)(() => {
		if (activeTab === "profile" && currentUser) {
			videos.myVideos(currentUser.id, currentUser.email).then((r) => setMyVideos(Array.isArray(r) ? r : [])).catch(() => setMyVideos([]));
			...
			(async () => {
				try {
					...
					setMeFollowersCount([...new Map(all.map((f) => [f.id, f])).values()].length);
				} catch (e) {}
			})();
			(async () => {
				try {
					...
					const all = [...r1?.items || r1 || [], ...r2?.items || r2 || []];
					setMeFollowingCount([...new Map(all.map((f) => [f.id, f])).values()].length);
				} catch (e) {}
			})();
		}
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			activeTab === "profile" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: !currentUser ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
										...
										onClick: async () => {
											...
											try {
												...
												setFollowersList([...new Map(all.map((f) => [f.id, f])).values()]);
											} catch (e) {
												setFollowersList([]);
											}
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
										...
										onClick: async () => {
											...
											try {
												const r1 = await request$1("GET", `/apps/69b2ee18a8e6fb58c7f0261c/entities/Follow?follower_id=${currentUser.id}&limit=500`).catch(() => null);
												const all = r1?.items || r1 || [];
												setFollowingList([...new Map(all.map((f) => [f.id, f])).values()]);
											} catch (e) {
												setFollowingList([]);
											}
											setFollowListLoading(false);
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(VideoManageGrid, {
						videos: myVideos,
						onRefresh: () => videos.myVideos(currentUser.id, currentUser.email).then((r) => setMyVideos(Array.isArray(r) ? r : [])).catch(() => {})
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...
			showFollowersList && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				style: {
					position: "fixed",
					inset: 0,
					background: "rgba(0,0,0,0.85)",
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					}), followListLoading ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						style: {
							textAlign: "center",
							padding: 40,
							color: "#888"
						...
						children: "Loading..."
					}) : followersList.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						style: {
							textAlign: "center",
							padding: 40,
							color: "#888"
					...
					}) : followersList.map((f, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						style: {
							display: "flex",
							alignItems: "center",
							gap: 14,
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
							src: `https://ui-avatars.com/api/?name=${encodeURIComponent(f.follower_username || "U")}&background=random&color=fff&size=80&bold=true&format=png`,
							style: {
								width: 48,
								height: 48,
								borderRadius: "50%",
							...
							children: f.follower_username || "Unknown"
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							style: {
								color: "#888",
								fontSize: 12
							},
							children: ["@", f.follower_username]
						})] })]
					}, f.id || i))]
				})
			}),
			showFollowingList && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				style: {
					position: "fixed",
					inset: 0,
					background: "rgba(0,0,0,0.85)",
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: "Loading..."
					}) : followingList.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						style: {
							textAlign: "center",
							padding: 40,
							color: "#888"
					...
					}) : followingList.map((f, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						style: {
							display: "flex",
							alignItems: "center",
							gap: 14,
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
							src: `https://ui-avatars.com/api/?name=${encodeURIComponent(f.following_username || "U")}&background=random&color=fff&size=80&bold=true&format=png`,
							style: {
								width: 48,
								height: 48,
								borderRadius: "50%",
							...
							children: f.following_username || "Unknown"
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							style: {
								color: "#888",
								fontSize: 12
							},
							children: ["@", f.following_username]
						})] })]
					}, f.id || i))]
				})
			}),
			...
			showAvatarPicker && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AvatarPickerModal, {
				...
				onSelect: async (url) => {
					...
					localStorage.setItem("sachi_user", JSON.stringify({
						...currentUser,
						avatar_url: url
					}));
					try {
						const usersData = await request$1("GET", `/apps/69b2ee18a8e6fb58c7f0261c/entities/AthaVidUser/?email=${encodeURIComponent(currentUser.email)}`);
						const match = (Array.isArray(usersData) ? usersData : usersData?.items || usersData?.records || []).find((u) => u.email === currentUser.email || u.user_id === currentUser.id);
						if (match) {
							if (url.startsWith("https://") || url.startsWith("http://")) await fetch("https://sachi-c7f0261c.base44.app/functions/uploadAvatar", {
								method: "POST",
								headers: { "Content-Type": "application/json" },
								body: JSON.stringify({
									image_base64: url,
					...
					try {
						const vidsData = await request$1("GET", `/apps/69b2ee18a8e6fb58c7f0261c/entities/SachiVideo/?username=${encodeURIComponent(currentUser.username || currentUser.email?.split("@")[0])}&limit=200`);
						const vids = Array.isArray(vidsData) ? vidsData : vidsData?.items || vidsData?.records || [];
						await Promise.all(vids.map((v) => request$1("PATCH", `/apps/69b2ee18a8e6fb58c7f0261c/entities/SachiVideo/${v.id}/`, { avatar_url: url })));
						setVideoList((vs) => vs.map((v) => v.user_id === currentUser.id || v.created_by === currentUser.id || v.username === (currentUser.username || currentUser.email?.split("@")[0]) ? {
							...v,
							avatar_url: url
						} : v));
					} catch (e) {
...
//#endregion
//#region src/PodcastHost.jsx
var API = "https://api.base44.app";
var APP_ID = "69b2ee18a8e6fb58c7f0261c";
var GOOGLE_CLIENT_ID = "742987369203-2in74gg9jdv3g14v8b0eo0g3clptp32gosdt.apps.googleusercontent.com";
var SACHI_FN = "https://sachi-c7f0261c.base44.app/functions";
var COVER_COLORS = [
	{
		bg: "linear-gradient(135deg,#1a0a2e,#6c3cf7)",
		emoji: "🎙️"
	},
	{
		bg: "linear-gradient(135deg,#0d2137,#1565C0)",
		emoji: "🎧"
	},
	{
		bg: "linear-gradient(135deg,#1a0a2e,#e53935)",
		emoji: "🔴"
	},
	{
		bg: "linear-gradient(135deg,#0a1a0a,#2e7d32)",
		emoji: "🌿"
	},
	{
		bg: "linear-gradient(135deg,#1a0f0a,#F57C00)",
		emoji: "🔥"
	},
	{
		bg: "linear-gradient(135deg,#0a0a1a,#F5C842)",
		emoji: "⭐"
	}
];
var CATEGORIES = [
...
function PodcastHost() {
	...
	const [myShows, setMyShows] = (0, import_react.useState)([]);
	const [loading, setLoading] = (0, import_react.useState)(true);
	const [selectedShow, setSelectedShow] = (0, import_react.useState)(null);
	const [view, setView] = (0, import_react.useState)("shows");
	const [goingLive, setGoingLive] = (0, import_react.useState)(false);
	const [endingLive, setEndingLive] = (0, import_react.useState)(false);
	const [streamUrl, setStreamUrl] = (0, import_react.useState)("");
	const [editingUrl, setEditingUrl] = (0, import_react.useState)(false);
	const [toast, setToast] = (0, import_react.useState)(null);
	...
	const [registering, setRegistering] = (0, import_react.useState)(false);
	const [epForm, setEpForm] = (0, import_react.useState)({
		title: "",
		description: "",
		video_url: "",
		episode_number: ""
	...
	const handleGoogleLogin = async (resp) => {
		setLoading(true);
		try {
			const data = await (await fetch(`https://api.base44.app/apps/${APP_ID}/auth/google`, {
				method: "POST",
				headers: { "Content-Type": "application/json" },
	...
	const loadMyShows = async () => {
		...
		try {
			...
			setMyShows((res.records || res || []).filter((p) => p.host_user_id === user?.id || p.created_by === user?.email || p.created_by_id === user?.id));
		} catch (e) {}
		setLoading(false);
	};
	const loadEpisodes = async (podcastId) => {
		try {
			...
			setEpisodes((res.records || res || []).filter((e) => e.podcast_id === podcastId));
		} catch (e) {}
	};
	const handleRegister = async () => {
		...
		try {
			await fetch(`${SACHI_FN}/podcastGoLiveNotify`, {
				...
				body: JSON.stringify({
					...
					host_name: selectedShow.host_name,
					live_stream_url: selectedShow.live_stream_url,
					set_live: true,
	...
	const endLive = async () => {
		...
		try {
			...
			await request("PATCH", `/apps/${APP_ID}/entities/SachiPodcast/${selectedShow.id}`, {
				is_live: false,
				listener_count: 0
			});
			setSelectedShow((s) => ({
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					...
					children: "Manage your Sachi podcast, go live, and add episodes — all from one place."
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					...
					children: "Use the same Google account you registered your podcast with"
				})
			]
		})
	});
		...
		children: [
			toast && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				style: {
					...
					left: "50%",
					transform: "translateX(-50%)",
					background: toast.type === "error" ? "#e53935" : toast.type === "live" ? "#e53935" : "#2e7d32",
					color: "#fff",
					borderRadius: 12,
					padding: "12px 24px",
					fontSize: 14,
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							style: s.title,
							children: "Sachi Podcast Host"
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							style: s.subtitle,
							children: ["Signed in as ", user.email]
						})]
					}),
					view !== "shows" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				style: s.body,
				children: [
					view === "shows" && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						style: {
							display: "flex",
							alignItems: "center",
							justifyContent: "space-between",
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							...
							style: s.smallBtn("linear-gradient(135deg,#F5C842,#F5A623)", "#0B0C1A"),
							children: "+ New Show"
						})]
					}), myShows.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						style: {
							textAlign: "center",
							padding: "48px 0"
						},
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								...
								children: "You don't have any shows yet."
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
								onClick: () => setView("register"),
								style: {
									...s.btn("linear-gradient(135deg,#F5C842,#F5A623)", "#0B0C1A"),
									width: "auto",
									padding: "14px 32px"
								},
								children: "Register Your First Show"
							})
						]
					}) : myShows.map((show) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								style: {
									...
									height: 56,
									borderRadius: 14,
									background: show.cover_color || "linear-gradient(135deg,#1a0a2e,#6c3cf7)",
									display: "flex",
									alignItems: "center",
									justifyContent: "center",
									fontSize: 24,
							...
							show.is_live && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								style: s.liveTag,
								children: "🔴 LIVE"
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					...
					view === "register" && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							style: {
								fontSize: 20,
								fontWeight: 800,
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
							style: s.input,
							placeholder: "e.g. The Daily Breakdown",
							value: regForm.title,
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							...
							children: COVER_COLORS.map((c, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								...
								style: {
									...
									fontSize: 22,
									cursor: "pointer",
									border: regForm.coverIdx === i ? "3px solid #F5C842" : "3px solid transparent"
								},
								children: c.emoji
							}, i))
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
							...
							style: s.btn("linear-gradient(135deg,#F5C842,#F5A623)", "#0B0C1A"),
							children: registering ? "Registering..." : "Register Show 🎙️"
						})
					] }),
					view === "manage" && selectedShow && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							style: {
								display: "flex",
								alignItems: "center",
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								style: {
									...
									height: 64,
									borderRadius: 16,
									background: selectedShow.cover_color || "linear-gradient(135deg,#1a0a2e,#6c3cf7)",
									display: "flex",
									alignItems: "center",
									justifyContent: "center",
									fontSize: 28
								},
								children: selectedShow.cover_emoji || "🎙️"
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								style: {
									fontSize: 20,
									fontWeight: 800
						...
						selectedShow.is_live ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							style: s.liveCard,
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								style: {
									textAlign: "center",
								...
								children: [
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										...
										children: [selectedShow.listener_count || 0, " listeners tuned in"]
									})
								]
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
								onClick: endLive,
								disabled: endingLive,
								style: s.btn("rgba(229,57,53,0.15)", "#e53935"),
								children: endingLive ? "Ending..." : "⏹️ End Live Session"
							})]
						}) : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							style: s.card,
							children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
									onClick: goLive,
									disabled: goingLive || !selectedShow.live_stream_url,
									style: {
										...s.btn(selectedShow.live_stream_url ? "linear-gradient(135deg,#e53935,#c62828)" : "rgba(255,255,255,0.06)"),
										opacity: selectedShow.live_stream_url ? 1 : .4
									},
									children: goingLive ? "Going Live..." : "🔴 Go Live Now"
								}),
								!selectedShow.live_stream_url && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
									style: {
										color: "rgba(255,255,255,0.3)",
										fontSize: 12,
										textAlign: "center",
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									style: s.smallBtn("rgba(108,60,247,0.3)", "#a78bfa"),
									children: "+ Add Episode"
								})]
							}), episodes.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								style: {
									...s.card,
									textAlign: "center",
									color: "rgba(255,255,255,0.3)",
								...
								children: "No episodes yet. Add your first one!"
							}) : episodes.sort((a, b) => b.episode_number - a.episode_number).map((ep) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								style: s.card,
								children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									style: {
										display: "flex",
					...
					view === "episode" && selectedShow && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							style: {
								fontSize: 20,
								fontWeight: 800,
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: ["Adding to: ", /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								style: { color: "#F5C842" },
								children: selectedShow.title
							})]
						}),
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", {
							style: s.label,
							children: "Video / Audio URL * (YouTube, Rumble, Spotify...)"
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
							style: s.input,
							placeholder: "https://youtube.com/watch?v=...",
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
							onClick: addEpisode,
							disabled: addingEp,
							style: s.btn("linear-gradient(135deg,#6c3cf7,#a78bfa)"),
							children: addingEp ? "Adding..." : "Add Episode ✅"
						})
					] })
				]
			})
...
function Root() {
	...
	if (path === "/podcast-host" || path === "/podcast-host/") return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PodcastHost, {});
