...
function GoogleSignInButton({ onVerified }) {
	const [error, setError] = (0, import_react.useState)("");
	const handleCredential = (0, import_react.useCallback)(async (response) => {
		setError("");
		try {
			const payload = JSON.parse(atob(response.credential.split(".")[1]));
			const found = await lookupSachiUser(payload.email);
...
function AuthModal({ onClose, onSuccess }) {
	const [step, setStep] = (0, import_react.useState)("google");
	const [googlePayload, setGooglePayload] = (0, import_react.useState)(null);
	(0, import_react.useEffect)(() => {
		const pending = localStorage.getItem("sachi_pending_google");
		if (pending) try {
			setGooglePayload(JSON.parse(pending));
			setStep("finish");
		} catch {}
	}, []);
	const handleVerified = ({ payload, existingUser }) => {
		if (existingUser) onSuccess(existingUser);
		else {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...
			children: [step === "google" && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				style: { textAlign: "center" },
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						style: {
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						...
						children: "Your stage. Share your truth with the world."
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(GoogleSignInButton, { onVerified: handleVerified }),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						style: {
							color: "#555",
							fontSize: 11,
			...
			}), step === "finish" && googlePayload && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FinishStep, {
				googlePayload,
				onSuccess
			})]
		})]
...
function App() {
	...
	(0, import_react.useEffect)(() => {
		if (!auth.getUser()) initGoogleOneTap((user) => {
			setCurrentUser(user);
			setFeedKey((k) => k + 1);
		});
	}, []);
