      ...
      <div style={{ position:"absolute",bottom:0,left:0,right:0,zIndex:10,padding:"0 0 80px 0" }}>
        ...
        <div style={{ display:"flex",borderTop:"1px solid rgba(255,255,255,0.08)",background:"rgba(0,0,0,0.6)",backdropFilter:"blur(10px)" }}>
          ...
          <button onClick={(e) => { e.stopPropagation(); onLike(video.id); }}
            ...
            <svg width="22" height="22" viewBox="0 0 24 24" fill={liked?"#e63946":"none"} stroke={liked?"#e63946":"rgba(255,255,255,0.7)"} strokeWidth="2">
          ...
          <button onClick={(e) => { e.stopPropagation(); setShowShare(true); }}
            style={{ flex:1,display:"flex",flexDirection:"column",alignItems:"center",gap:4,padding:"12px 0",background:"none",border:"none",cursor:"pointer" }}>
            <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="rgba(255,255,255,0.7)" strokeWidth="2">
